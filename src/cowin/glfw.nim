when defined(emscripten):
  ...
  when defined(windows):
    ...
    when defined(vcc):
      ...
      {.link: "user32.lib".}
    {.
      compile: "glfw/win32_init.c",
      compile: "glfw/win32_joystick.c",
      compile: "glfw/win32_monitor.c",
      compile: "glfw/win32_time.c",
      compile: "glfw/win32_thread.c",
      compile: "glfw/win32_window.c",
      compile: "glfw/wgl_context.c",
      compile: "glfw/egl_context.c",
      compile: "glfw/osmesa_context.c"
    .}
  elif defined(macosx):
    {.
      passC: "-D_GLFW_COCOA",
      passL: "-framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo",
      compile: "glfw/cocoa_init.m",
      compile: "glfw/cocoa_joystick.m",
      compile: "glfw/cocoa_monitor.m",
      compile: "glfw/cocoa_window.m",
      compile: "glfw/cocoa_time.c",
      compile: "glfw/posix_thread.c",
      compile: "glfw/nsgl_context.m",
      compile: "glfw/egl_context.c",
      compile: "glfw/osmesa_context.c"
    .}
  elif defined(linux):
    ...
    when defined(wayland):
      {.
        ...
        compile: "glfw/wl_init.c",
        compile: "glfw/wl_monitor.c",
        compile: "glfw/wl_window.c",
        compile: "glfw/posix_time.c",
        compile: "glfw/posix_thread.c",
        compile: "glfw/xkb_unicode.c",
        compile: "glfw/egl_context.c",
        compile: "glfw/osmesa_context.c"
      .}
    else:
      {.
        passC: "-D_GLFW_X11",
        compile: "glfw/x11_init.c",
        compile: "glfw/x11_monitor.c",
        compile: "glfw/x11_window.c",
        compile: "glfw/xkb_unicode.c",
        compile: "glfw/posix_time.c",
        compile: "glfw/posix_thread.c",
        compile: "glfw/glx_context.c",
        compile: "glfw/egl_context.c",
        compile: "glfw/osmesa_context.c"
      .}

    {.compile: "glfw/linux_joystick.c".}
  else:
    # If unsupported/unknown OS, use null system
    {.
      compile: "glfw/null_init.c",
      compile: "glfw/null_monitor.c",
      compile: "glfw/null_window.c",
      compile: "glfw/null_joystick.c",
      compile: "glfw/posix_time.c",
      compile: "glfw/posix_thread.c",
      compile: "glfw/osmesa_context.c"
    .}
  ...
  # Common
  {.
    compile: "glfw/context.c",
    compile: "glfw/init.c",
    compile: "glfw/input.c",
    compile: "glfw/monitor.c",
    compile: "glfw/vulkan.c",
    compile: "glfw/window.c"
  .}
